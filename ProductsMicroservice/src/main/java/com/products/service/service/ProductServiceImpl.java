...
import com.products.service.data.ProductEntity;
import com.products.service.data.ProductsRepository;
...
public class ProductServiceImpl implements ProductsService {
    ...
    @Override
    public ProductResponseModel reduceStock(String id, int quantity) {
